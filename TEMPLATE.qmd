...
| ----                 | ---    | ---     | ---     | ---     | ---             | ----         | ----        | 
| data/raw/example.dta | yes    | no      | yes     | yes     | no              | yes          | yes         |
| example2.dta         | yes    | no      | -       | -       | no              | no           | yes         |
| BLS                  | no     | no      | yes     | yes     | no              | yes          | yes          |
...
{{< include generated/report-secrets.md >}}
...
{{< include generated/report-code-quality.md >}}

{{< include generated/report-llm-reproducibility.md >}}
